...
async function enrichFlightInfo(adapter, config, a, httpJson, httpText, logDebug, logWarn) {
	...
	try {
		...
		if (
			(mergedRoute == null ? void 0 : mergedRoute.originIata) &&
			(mergedRoute == null ? void 0 : mergedRoute.destIata)
		) {
			parsed.routeCallsign =
				(flighteraRoute == null ? void 0 : flighteraRoute.routeCallsign) ||
				(hexRoute == null ? void 0 : hexRoute.routeCallsign) ||
				parsed.routeCallsign ||
				operationalCallsign;
			...
			if (
				(hexRoute == null ? void 0 : hexRoute.originIata) &&
				(hexRoute == null ? void 0 : hexRoute.destIata) &&
				(flighteraRoute == null ? void 0 : flighteraRoute.originIata) &&
				(flighteraRoute == null ? void 0 : flighteraRoute.destIata) &&
				(hexRoute.originIata !== flighteraRoute.originIata || hexRoute.destIata !== flighteraRoute.destIata)
			) {
				parsed.routeWarning = (flighteraRoute == null ? void 0 : flighteraRoute.isLive)
					? 'Flightera Live bevorzugt, HexDB abweichend'
					: 'HexDB bevorzugt, Flightera abweichend';
				parsed.routeSource = (flighteraRoute == null ? void 0 : flighteraRoute.isLive)
		...
		if (!routeFound) {
			...
			if (
				(adsbdbRoute == null ? void 0 : adsbdbRoute.originIata) &&
				(adsbdbRoute == null ? void 0 : adsbdbRoute.destIata)
			) {
...
function mergeHexAndFlighteraRoute(hexRoute, flighteraRoute) {
	const flighteraComplete =
		...
		!!(flighteraRoute == null ? void 0 : flighteraRoute.destIata);
	const hexComplete =
		!!(hexRoute == null ? void 0 : hexRoute.originIata) && !!(hexRoute == null ? void 0 : hexRoute.destIata);
...
function scoreFlighteraRow(r, op, iataLike, mode, config) {
	...
	if (mode === 'TAKEOFF' && r.originIata === config.airport.iata) score += 1e3;
	if (mode === 'LANDING' && r.destIata === config.airport.iata) score += 1e3;
...
async function getSystemLanguage(adapter) {
	...
	try {
		...
		return String(
			((_a = obj == null ? void 0 : obj.common) == null ? void 0 : _a.language) ||
				((_b = obj == null ? void 0 : obj.native) == null ? void 0 : _b.language) ||
				'',
		).trim();
	} catch {
		return '';
