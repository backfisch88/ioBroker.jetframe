...
async function ensureBaseStates(adapter, config) {
	...
	try {
		...
		if (
			(speechEnabledState == null ? void 0 : speechEnabledState.val) === null ||
			(speechEnabledState == null ? void 0 : speechEnabledState.val) === void 0
		) {
...
async function writeFlight(adapter, base, a) {
	...
	await adapter.setForeignStateAsync(
		`${base}.landingTrackDiffDeg`,
		(0, import_geo.round)(a.landingTrackDiffDeg || 0, 1),
		true,
	);
	await adapter.setForeignStateAsync(
		`${base}.takeoffTrackDiffDeg`,
		(0, import_geo.round)(a.takeoffTrackDiffDeg || 0, 1),
		true,
	);
	await adapter.setForeignStateAsync(
		`${base}.airportTrackDiffDeg`,
		(0, import_geo.round)(a.airportTrackDiffDeg || 0, 1),
		true,
	);
